            ...
            <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-lg">
                ...
                <form className="mt-8 space-y-6" onSubmit={handleLogin}>
                    ...
                    <div className="rounded-md shadow-sm -space-y-px">
                        ...
                        <div className='flex appearance-none rounded-none relative w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm'>
                            ...
                            <input
                                ...
                                required
                                className="appearance-none rounded-none relative block w-full border-0 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
